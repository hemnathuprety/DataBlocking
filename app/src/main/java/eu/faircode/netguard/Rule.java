...
public class Rule {
    ...
    public static Boolean isWifiEnabled(Context context, String packageName) {
        SharedPreferences wifiSharedPref = context.getSharedPreferences("wifi", Context.MODE_PRIVATE);
//        rule.wifi_blocked = (!(rule.system && !manage_system) && wifiSharedPref.getBoolean(info.packageName, rule.wifi_default));
        boolean wifiStatus = wifiSharedPref.getBoolean(packageName, false);
        return wifiStatus;
    }

    public static Boolean isDataEnabled(Context context, String packageName) {
        SharedPreferences dataSharedPref = context.getSharedPreferences("other", Context.MODE_PRIVATE);
        return dataSharedPref.getBoolean(packageName, false);
    }
    ...
    private void updateChanged(boolean default_wifi, boolean default_other,
                               boolean default_roaming) {
    ...
    public static void toggleWifiData(@NotNull Context context, boolean toggle, @NotNull String packageName) {
        SharedPreferences wifiSharedPref = context.getSharedPreferences("wifi", Context.MODE_PRIVATE);
        wifiSharedPref.edit().putBoolean(packageName,toggle).apply();
        ServiceSinkhole.reload("rule changed", context, false);
//        wifiSharedPref
       //wifiSharedPref.getBoolean(info.packageName, rule.wifi_default)
    }

    public static void toggleMobileData(@NotNull Context context, boolean toggle, @NotNull String packageName) {
